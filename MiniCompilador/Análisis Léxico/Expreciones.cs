...
namespace MiniCompilador.Análisis_Léxico
{
    ...
    {      
        ...
        public Expreciones()
        {
            palabrasReservadas = new Regex(@"^(void|const|int|double|bool|string|class|interface|null|this|for|while|foreach|if|else|return|break|New|NewArray|Console|WriteLine)$");
