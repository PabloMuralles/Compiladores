    ...
    class Analysis
    {
        ...
        private void ClassifyIdent()
        {
            ...
            if (dataListNext.Item1 == ";")
            {
                ...
                if (!ExistInTable(dataListActuals.Item1))
                {

                }
                else
                {
                    mistakes.Add($"Error la variable :{dataListActuals.Item1} ya fue definida con anterioridad");
                }
            }
            ...
            else if (dataListNext.Item1 == "=")
            {
                ...
                {
                    mistakes.Add($"Error la variable :{dataListActuals.Item1} no fue definida con anterioridad");
                }
            }
            //creacion de una funcion o precedimiento
            else if (dataListNext.Item1 == "(")
            {
                var name = dataListActuals.Item1;
                ...
                {
                    mistakes.Add($"Error la Funcion :{dataListActuals.Item1} ya fue declarada con anterioridad");
                }
